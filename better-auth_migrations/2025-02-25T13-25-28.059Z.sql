create table "user" ("id" text not null primary key, "name" text not null, "email" text not null unique, "emailVerified" boolean not null, "image" text, "createdAt" timestamp not null, "updatedAt" timestamp not null, "userType" text not null, "phoneNumber" text not null, "countryCode" text, "timezone" text, "companyUuid" text, "companyName" text, "companyAddress" text, "postCode" text, "role" text not null references "rbac" ("id"));
